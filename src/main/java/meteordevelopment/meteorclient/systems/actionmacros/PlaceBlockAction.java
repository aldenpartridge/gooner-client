...
/**
 * Records and replays block placement.
 */
public class PlaceBlockAction extends RecordedAction {
    private BlockPos blockPos;
    private Direction direction;
    private Hand hand;

    public PlaceBlockAction(long timestamp, BlockPos blockPos, Direction direction, Hand hand) {
        super(timestamp);
    ...
    public PlaceBlockAction(NbtCompound tag) {
    ...
    public String getDescription() {
        return String.format("Place block at (%d, %d, %d)", blockPos.getX(), blockPos.getY(), blockPos.getZ());
    }
}
